                    ...
                    <div class="header bline">
                        ...
                        <ul class="header-dropdown dropdown dropdown-animated scale-left">
                            <li><a class="btn btn-default btn-sm" href="javascript:void(0);"
                                    data-toggle="tooltip" data-placement="top" title="Monthly">Monthly</a>
                            </li>
                            ...
                            <table class="table table-hover js-basic-example dataTable table-custom mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                class="btn btn-sm round btn-outline-success">Accept</button>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <span class="name">@Folisise Chosielie <small
                                                    class="float-right">45 hours ago</small></span>
                                            <span class="message">There are many variations of passages of
                                                Lorem Ipsum available, but the majority</span>
                                            <span class="badge badge-outline status"></span>
                                        </div>
                                    </div>
                                </a>
